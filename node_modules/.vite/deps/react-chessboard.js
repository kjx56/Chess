...
var isDifferentFromStart = (newPosition) => {
  ...
  Object.keys(startPositionObject).forEach((square) => {
    if (newPosition[square] !== startPositionObject[square])
      isDifferent = true;
  });
  Object.keys(newPosition).forEach((square) => {
    if (startPositionObject[square] !== newPosition[square])
      isDifferent = true;
  });
  return isDifferent;
};
...
var ChessboardProvider = (0, import_react.forwardRef)(({
  ...
  function handleSetPosition(sourceSq, targetSq, piece) {
    ...
    if (!arePremovesAllowed && waitingForAnimation)
      return;
...
var borderRadius = (customBoardStyle, square, boardOrientation) => {
  if (!customBoardStyle.borderRadius)
    return {};
  if (square === "a1") {
